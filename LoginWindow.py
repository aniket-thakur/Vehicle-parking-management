...
class LoginScreen(QWidget):
    def __init__(self):               #constructor
        ...
        btn_login.setStyleSheet("padding:5px;font-size:20px;background:#236931;color:#fff")
        ...
        layout.addStretch()
        btn_login.clicked.connect(self.showHome)   # connecting login button to a function
        self.setLayout(layout)

    def showLoginScreen(self):
        self.show()                    # creating login screen object
