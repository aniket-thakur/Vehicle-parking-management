...
class HomeScreen(QMainWindow):
    def __init__(self):                   #constructor
        ...
        widget=QWidget()                  # creating a  QWidget object
        widget.setStyleSheet("background:#004D33")
        layout_horizontal=QHBoxLayout()                 #creating horizontal layout object dividing into menu and pages
        menu_vertical_layout=QVBoxLayout()              #creating vertical  layout object for menu
        # creatinng button for all 4 objects
        ...
        self.btn_home.setStyleSheet("width:200px;height:170px;font-size:20px;background:#5D8AA8;color:#1A0015;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:170px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:170px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:170px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")

         # connecting all menu button to function
        ...
        parent_vertical=QVBoxLayout()              #creating vertical layout object for all 4 frames
        parent_vertical.setContentsMargins(0,0,0,0)

        #Adding all Frames into the vertical layout
    ...
    # in this all function(showHome,showAdd...showHistory) a single frame will be show and other frames will be hidden
    # ie if click on home button it will show Home only and other pages will be hidden


    def showHome(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#8066FF;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def showAdd(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#8066FF;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def showManage(self):
        self.btn_home.setStyleSheet(
            "width:200px;height:160px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet(
            "width:200px;height:160px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet(
            "width:200px;height:160px;font-size:20px;background:#8066FF;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def showHistory(self):
        ...
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:#5D8AA8;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:#8066FF;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def addHomePageData(self):
        ...
        for data in alldata:
            ...
            if data[3]==1:
                label.setStyleSheet("background-color:green;color:white;padding:6px;width:100px;height:100px;border:2px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet("background-color:#EFDECD;color:red;padding:6px;width:100px;height:100px;border:2px solid white;text-align:center;font-weight:bold")
    ...
    def addAddStudentPage(self):
        ...
        name_label.setStyleSheet("color:#E6F2FF;padding:8px 0px;font-size:20px")
        mobile_label=QLabel("Mobile : ")
        mobile_label.setStyleSheet("color:#E6F2FF;padding:8px 0px;font-size:20px")
        ...
        error_label=QLabel("")
        error_label.setStyleSheet("color:green;padding:8px 0px;font-size:20px")
    ...
    def addManagePage(self):
        ...
        self.table.setStyleSheet("background:#c18591")
        ...
        for smalldata in data:
            ...
            self.button_exit.setStyleSheet("color:white;padding:8px 0px;font-size:20px;background:green;border:1px solid white")
    ...
    def addHistoryPage(self):
        ...
        self.table1.setRowCount(len(data))
        self.table1.setStyleSheet("background:#a6bf8a")
        self.table1.setColumnCount(7)

        button=QPushButton("Refresh")
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#25bf0d;border:1px solid white")
